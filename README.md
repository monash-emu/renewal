<b>Evaluating the effects of population mobility on the COVID-19 pandemic</b>
...
If you do not have pixi installed, you can obtain it from
https://pixi.sh/latest/installation/

Then, to build the environment for this repository, run
...
(or using your preferred notebook viewer, eg VSCode)
