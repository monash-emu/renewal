...
class StandardCalib(Calibration):
    ...
    def add_factor(self, params, indicator):
        ...
        dispersion = numpyro.sample(f"dispersion_{indicator}", dist.HalfNormal(self.data_disp_sd[indicator]))
    ...
    def describe_like_contribution(self, indicator):
        return (
            ...
            f"with a standard deviation of {self.data_disp_sd[indicator]}. "
        )
