...
if __name__=="__main__":
    ...
    extension = "a"
    analysis_name = f"run_{datetime.now().strftime('%Y%m%d')}_{extension}"
    ...
    for mob_analysis_type in ANALYSIS_TYPES:
        run_single_country(country, 10, 7, 50, mob_analysis_type, 100, hosp_out, hosp_out_name, analysis_name, num_chains=8)
